...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Pannel",font=("verdana",45,"bold"),bg="black",fg="white")
        ...
        main_frame.place(x=5,y=150,width=1355,height=510)
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="Branch",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","Branch","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport_left.heading("Branch",text="Branch")
        ...
        self.attendanceReport_left.column("Branch",width=100)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","Branch","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport.heading("Branch",text="Branch")
        ...
        self.attendanceReport.column("Branch",width=100)
        ...
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set std_id=%s,std_Branch=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",( 
                    self.var_id.get(),
                    self.var_roll.get(),
                    self.var_name.get(),
                    self.var_time.get(),
