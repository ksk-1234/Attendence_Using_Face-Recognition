...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="FACE RECOGNITION",font=("verdana",30,"bold"),bg="black",fg="white")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                cursor.execute("select Branch from student where Rollno="+str(id))
                b=cursor.fetchone()
                b="+".join(b)
                ...
                if confidence > 77:
                    cv2.putText(img,f"Rollno:{r}",(x,y-80),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
